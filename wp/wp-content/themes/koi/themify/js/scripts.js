			...
			"uploadifyComplete" : function(event, id, file, response, data){
				if(!response || response == false){
					...
					if(complete_status == false){
						...
						var el = $('<a href="#" style="display:none;" title="' + title + '"><span title="' + title + '"></span><img src="' + app_url + 'img_x.php?w=50&h=50&src=' + path + '" alt="' + path + '" class="backgroundThumb selected"  /></a>').fadeIn(1000);
