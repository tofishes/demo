                            ...
                            $("#themify_upload_image_<?php echo $meta_box['name']; ?>").uploadify({
                                ...
                                $("#themify_upload_image_<?php echo $meta_box['name']; ?>").bind({
                                    ...
                                    "uploadifyComplete": function (a, b, c, d, e) {
                                        ...
                                        $(this).parent().parent().parent().find(".themify_upload_preview").html("<img src=\'<?php echo get_bloginfo('template_directory'); ?>/themify/img_x.php?w=40&h=40&src=" + f + "\' alt=\'" + f + "\' />").fadeIn(200);
                                    }
                                });
                            <?php endif; ?>
                            <?php endforeach; ?>
